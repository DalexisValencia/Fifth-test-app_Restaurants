...
class _PopularSuggestionsState extends State<PopularSuggestions> {
  List<Popular> example = [
    Popular(
        ...
        '4.6',
        '32.000',
        RelatedComment('Jessica simons', 'image',
    ...
    Popular(
        ...
        '4.8',
        '17.000',
        RelatedComment('Miguel Rios', 'image',
    ...
    Popular(
        ...
        '4.7',
        '17.000',
        RelatedComment('Nataly Santana', 'image',
            'It is a special place to visit in family. The neighborhood is nice.'),
        Color(0xFF4F57D5))
  ];
  @override
  Widget build(BuildContext context) {
    return Builder(builder: (BuildContext context) {
      return new Column(
          children:
              example.map((item) => new PopularCard(comment: item)).toList());
    });
  }
}
...
class PopularCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: EdgeInsets.symmetric(horizontal: withDefaultPadding - 5),
                    ...
                    Container(
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              fit: BoxFit.cover,
                              image: ExactAssetImage(comment.image))),
